...
#import "YDSafeMutableDictionary.h"

@interface YDSafeMutableDictionary ()
  ...
  @synchronized(self) {
    if (self.queue == nil) {
      NSString *name = [NSString
          stringWithFormat:@"com.madding.tsafe.dictionary.%ld",
...
- (NSString *)description {
  return [NSString stringWithFormat:@"YDThreadSafeDictionary: %@",
...
#define YDSafeMutableDictionaryCodingKeyBackingStore \
  @"YDSafeMutableDictionaryCodingKeyBackingStore"
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
  self = [super init];
  if (self) {
    _backingStore = [[aDecoder decodeObjectOfClass:[NSDictionary class
    ] forKey:YDSafeMutableDictionaryCodingKeyBackingStore] mutableCopy];
    [self createQueue];
  }
  return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
  [aCoder encodeObject:[_backingStore copy]
                forKey:YDSafeMutableDictionaryCodingKeyBackingStore];
}
