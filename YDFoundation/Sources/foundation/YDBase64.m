...
static const char *kYDStdBase64Chars =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

static const char *kYDUrlSafeBase64Chars =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";

void *decodeBase64(const char *inputBuffer, size_t length, size_t *outputLength,
                   char ch63, char ch64);

@implementation YDBase64

+ (NSString *)encodeStandardBase64ForData:(NSData *)iData {
  return [YDBase64 encodeBase64ForData:iData
                                    charList:kYDStdBase64Chars
                                        ch65:'='];
}
...
+ (NSString *)encodeUrlSafeBase64ForData:(NSData *)iData {
  return [YDBase64 encodeBase64ForData:iData
                                    charList:kYDUrlSafeBase64Chars
                                        ch65:' '];
}
