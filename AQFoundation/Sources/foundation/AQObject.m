...
+ (id)performSelector:(id)obj seletor:(SEL)selector {
  ...
  if ([AQObject isRespondsToSelector:obj selector:selector]) {
...
+ (NSInteger)asInteger:(id)object {
  return [[AQObject asNSNumber:object] integerValue];
}

+ (float)asFloat:(id)object {
  return [[AQObject asNSNumber:object] floatValue];
}

+ (BOOL)asBool:(id)object {
  return [[AQObject asNSNumber:object] boolValue];
}
...
+ (NSDate *)asNSDate:(id)object {
  ...
  return [NSDate dateWithTimeIntervalSince1970:[AQObject asNSNumber:object].doubleValue];
}
...
+ (NSMutableDictionary *)asNSMutableDictionary:(id)object {
  ...
  NSDictionary * dict = [AQObject asNSDictionary:object];
  if ( nil == dict )
    return nil;
