 ...
 *  @return <#return value description#>
 */
+ (NSArray /*AQRTProtocol*/ *)rt_protocols:(Class)clazz;
 ...
 *  @return <#return value description#>
 */
+ (NSArray /*AQRTMethod*/ *)rt_methods:(Class)clazz;
 ...
 *  @return <#return value description#>
 */
+ (NSArray /*AQRTIvar*/ *)rt_ivars:(Class)clazz;
 ...
 *  @return <#return value description#>
 */
+ (NSArray /*AQRTProperty*/ *)rt_properties:(Class)clazz;
