 ...
 * 通过Method 变量构造的子类
 */
@interface AQRTObjCMethod : AQRTMethod {
  Method _m;
}

@end

@implementation AQRTObjCMethod
 ...
 */
@interface AQRTComponentsMethod : AQRTMethod {
  SEL _sel;
  IMP _imp;
  NSString *_sig;
}
...
@implementation AQRTComponentsMethod
...
- (id)initWithObjCMethod:(Method)method {
  return [[AQRTObjCMethod alloc] initWithObjCMethod:method];
}

- (id)initWithSelector:(SEL)sel imp:(IMP)imp sign:(NSString *)sign {
  return
      [[AQRTComponentsMethod alloc] initWithSelector:sel imp:imp sign:sign];
}
...
- (BOOL)isEqual:(id)other {
  return [other isKindOfClass:[AQRTMethod class]] &&
