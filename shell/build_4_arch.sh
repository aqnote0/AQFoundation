...
BUILD_ARCHS="${BUILD_ARCHS} -arch armv7 -arch arm64"
...
xcodebuild clean build -workspace ${WORKSPACE} -configuration "${FRAMEWORK_CONFIG}" -scheme "${SCHEME}" -sdk iphonesimulator -destination 'name=iPhone 6'
